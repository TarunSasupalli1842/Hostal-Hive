                ...
                <div style={{
                    ...
                    <Link to="/student-login" style={{ textDecoration: 'none' }}>
                        <div style={{
                            ...
                            <h2 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '16px', color: '#1e293b' }}>Student Portal</h2>
                            <p style={{ color: '#64748b', fontSize: '18px', marginBottom: '40px', lineHeight: '1.5' }}>
                                Find your next home, book rooms, and manage your accommodation experience.
                            </p>
                            <div style={{
                                width: '100%',
                                padding: '18px',
                    ...
                    <Link to="/admin-login" style={{ textDecoration: 'none' }}>
                        <div style={{
                            ...
                            <h2 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '16px', color: 'white' }}>Admin Nexus</h2>
                            <p style={{ color: '#94a3b8', fontSize: '18px', marginBottom: '40px', lineHeight: '1.5' }}>
                                For property managers and administrators to oversee listings and bookings.
                            </p>
                            <div style={{
                                width: '100%',
                                padding: '18px',
